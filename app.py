...
def create_brochure_excel(car_details, specs):
    ...
    with pd.ExcelWriter(excel_buffer, engine='xlsxwriter') as writer:
        ...
        ws.merge_range('A10:B10', 'TECHNICAL SPECIFICATIONS & DETAILS', sub_fmt)
    ...
    # =========================================================
        ...
        with tab3:
            ...
            if not df_live_stock.empty:
                ...
                # 🟢 NEW FEATURE: 1-Click Editable Digital Spec Sheet Generator (Brochure Studio)
                st.markdown("---")
                ...
                # Admin Stock Processing Section (Hidden from Reps)
